...
Rectangle {
        ...
        Repeater {
            ...
            delegate: Item {
                ...
                Text {
                    ...
                    font.family: "Pixelify Sans"; font.weight: Font.Bold; font.pixelSize: 10 * s; font.letterSpacing: 2 * s
    ...
    Column {
        ...
        Row {
            ...
            Text {
                ...
                color: "white"; font.family: "Pixelify Sans"; font.weight: Font.Bold; font.pixelSize: 100 * s; font.letterSpacing: -5 * s
            ...
            Text {
                ...
                color: root.signTeal; font.family: "Pixelify Sans"; font.weight: Font.Bold; font.pixelSize: 100 * s; font.letterSpacing: -5 * s
        ...
        Text {
            ...
            color: "white"; font.family: "Pixelify Sans"; font.weight: Font.Bold; font.pixelSize: 12 * s; font.letterSpacing: 8 * s
            opacity: 0.8
            layer.enabled: true; layer.effect: DropShadow { color: "#80000000"; radius: 4; samples: 8; horizontalOffset: 1; verticalOffset: 1 }
        }
    }
    ...
    Column {
        ...
        Item {
            ...
            TextInput {
                id: pwd; anchors.fill: parent; color: root.signPink; font.family: "Pixelify Sans"; font.weight: Font.Bold; font.pixelSize: 18 * s; font.letterSpacing: 6 * s
            ...
            Text { anchors.centerIn: parent; text: "CONNECTING..."; color: root.signTeal; opacity: 0.3; font.family: "Pixelify Sans"; font.weight: Font.Bold; font.pixelSize: 12 * s; font.letterSpacing: 4 * s; visible: !pwd.text && !pwd.activeFocus }
        }

        Text { id: err; text: ""; color: "#ff4444"; anchors.horizontalCenter: parent.horizontalCenter; font.family: "Pixelify Sans"; font.weight: Font.Bold; font.pixelSize: 12 * s }
    }
