...
Rectangle {
    ...
    Column {
        ...
        Text {
            ...
            color: cWhite
            font.family: Orbitron; font.pixelSize: 96 * s
        ...
        Text {
            ...
            color: cSteel
            font.family: Orbitron; font.pixelSize: 12 * s
    ...
    Column {
        ...
        Text {
            ...
            font.family: Orbitron; font.pixelSize: 22 * s
        ...
        Item {
            ...
            TextInput {
                ...
                color: cWhite
                font.family: Orbitron; font.pixelSize: 20 * s; font.letterSpacing: 10 * s
                ...
                Text {
                    ...
                    font.family: Orbitron; font.pixelSize: 13 * s
        ...
        Row {
            ...
            Repeater {
                ...
                delegate: Text {
                    ...
                    font.family: Orbitron; font.pixelSize: 11 * s
                    font.letterSpacing: 2 * s; font.weight: Font.Light
        ...
        Text {
            ...
            font.family: Orbitron; font.pixelSize: 11 * s; font.letterSpacing: 1.5 * s
        }
    }
