    ...
    Item {
        ...
        Column {
            ...
            Text {
                ...
                color: root.cInk; font.family: Itim; font.pixelSize: 84 * s
            ...
            Text {
                ...
                color: root.cSub; font.family: Itim; font.pixelSize: 18 * s; font.letterSpacing: 1 * s
            }
        }
    }
    ...
    Item {
        ...
        Column {
            ...
            Text {
                ...
                color: userMa.containsMouse ? root.cPink : root.cInk; font.family: Itim; font.pixelSize: 18 * s; font.letterSpacing: 4 * s
            ...
            Rectangle {
                ...
                TextInput {
                    ...
                    font.family: Itim; font.pixelSize: 18 * s; font.letterSpacing: 8 * s
                    ...
                    Text {
                        ...
                        font.family: Itim; font.pixelSize: 14 * s; font.letterSpacing: 2 * s
            ...
            Text {
                ...
                text: ""; color: root.cPink; font.family: Itim; font.pixelSize: 12 * s; font.letterSpacing: 1 * s
                visible: text !== ""
            }
            ...
            Row {
                ...
                Repeater {
                    ...
                    delegate: Text {
                        ...
                        color: actMa.containsMouse ? root.cPink : root.cSub; font.family: Itim; font.pixelSize: 11 * s; font.letterSpacing: 2 * s
                        Behavior on color { ColorAnimation { duration: 200 } }
                        MouseArea {
