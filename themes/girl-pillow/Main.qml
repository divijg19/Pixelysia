    ...
    Item {
        ...
        Column {
            ...
            Text {
                ...
                color: root.cText; font.family: Itim; font.pixelSize: 96 * s
            ...
            Text {
                ...
                anchors.horizontalCenter: parent.horizontalCenter
                color: root.cSub; font.family: Itim; font.pixelSize: 22 * s; font.letterSpacing: 1 * s
            }
        }
    }
    ...
    Item {
        ...
        Column {
            ...
            Text {
                ...
                color: userMa.containsMouse ? root.cAccent : root.cText; font.family: Itim; font.pixelSize: 18 * s; font.letterSpacing: 4 * s
            ...
            Rectangle {
                ...
                TextInput {
                    ...
                    font.family: Itim; font.pixelSize: 20 * s; font.letterSpacing: 8 * s
                    ...
                    Text {
                        ...
                        font.family: Itim; font.pixelSize: 15 * s; font.letterSpacing: 2 * s
            ...
            Text {
                ...
                text: ""; color: "#cc4444"; font.family: Itim; font.pixelSize: 12 * s; font.letterSpacing: 1 * s
                visible: text !== ""
            }
            ...
            Row {
                ...
                Repeater {
                    ...
                    delegate: Text {
                        ...
                        color: actMa.containsMouse ? root.cAccent : root.cSub; font.family: Itim; font.pixelSize: 12 * s; font.letterSpacing: 3 * s
                        Behavior on color { ColorAnimation { duration: 200 } }
                        MouseArea {
