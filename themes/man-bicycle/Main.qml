...
Rectangle {
    ...
    Column {
        ...
        Text {
            ...
            font.family: Itim; font.pixelSize: 20 * s
    ...
    Column {
        ...
        Text {
            ...
            font.family: Itim; font.pixelSize: 34 * s
        ...
        Item {
            ...
            TextInput {
                ...
                color: cWhite
                font.family: Itim; font.pixelSize: 26 * s; font.letterSpacing: 8 * s
                ...
                Text {
                    ...
                    font.family: Itim; font.pixelSize: 14 * s
        ...
        Text {
            ...
            font.family: Itim; font.pixelSize: 12 * s; font.letterSpacing: 1 * s
        }
    }
