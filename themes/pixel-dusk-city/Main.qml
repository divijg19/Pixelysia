...
Rectangle {
    ...
    Column {
        ...
        Text {
            ...
            font.family: "Pixelify Sans"; font.weight: Font.Bold; font.pixelSize: 78 * s
        ...
        Row {
            ...
            Text {
                ...
                color: root.amberSoft; font.family: "Pixelify Sans"; font.weight: Font.Bold
        ...
        Column {
            ...
            Item {
                ...
                Text {
                    ...
                    font.family: "Pixelify Sans"; font.weight: Font.Bold; font.pixelSize: 14 * s; font.letterSpacing: 3 * s
                ...
                TextInput {
                    ...
                    anchors.verticalCenter: parent.verticalCenter; anchors.verticalCenterOffset: -1 * s
                    color: root.textWhite
                    font.family: "Pixelify Sans"; font.pixelSize: 14 * s; font.letterSpacing: 3 * s; font.weight: Font.Bold
                ...
                Item {
                    ...
                    Text {
                        ...
                        text: "LOGIN"
                        color: root.amberHot
                        font.family: "Pixelify Sans"; font.weight: Font.Bold; font.pixelSize: 9 * s; font.letterSpacing: 2 * s
            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    Text {
                        ...
                        font.family: "Pixelify Sans"; font.weight: Font.Bold; font.pixelSize: 9 * s; font.letterSpacing: 1 * s
                    }
                    MouseArea {
    ...
    function doLogin() {
        ...
        sddm.login(uname, passwordField.text, 0)
    }
}
