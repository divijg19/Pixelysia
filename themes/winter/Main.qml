    ...
    Item {
        ...
        Column {
            ...
            Text {
                ...
                font.family: Orbitron; font.pixelSize: 18 * s
            ...
            Column {
                ...
                Item {
                    ...
                    Item {
                        ...
                        Column {
                            ...
                            Text { anchors.horizontalCenter: parent.horizontalCenter; text: "USER"; font.family: Orbitron; font.pixelSize: 10 * s; font.letterSpacing: 4 * s; color: root.textSecondary; opacity: 0.8 }
                            Text {
                                text: (userHelper.currentItem && userHelper.currentItem.uName ? userHelper.currentItem.uName : "UNKNOWN").toUpperCase()
                                font.family: Orbitron; font.pixelSize: 18 * s; font.letterSpacing: 3 * s; font.weight: Font.Bold; color: uClickMa.containsMouse ? root.accent : root.textPrimary; anchors.horizontalCenter: parent.horizontalCenter
                ...
                Item {
                    ...
                    TextInput {
                        ...
                        font.family: Orbitron; font.pixelSize: 32 * s; font.letterSpacing: 10 * s
                        ...
                        Text {
                            anchors.centerIn: parent
                            text: "PASSWORD"; font.family: Orbitron
        ...
        Item {
            ...
            Row {
                ...
                Text { text: "SESSION"; font.family: Orbitron; font.pixelSize: 12 * s; font.letterSpacing: 2 * s; color: root.textSecondary; anchors.verticalCenter: parent.verticalCenter }
                ...
                Text {
                    ...
                    font.family: Orbitron; font.pixelSize: 14 * s; font.weight: Font.Bold; font.letterSpacing: 1 * s; color: sessionMa.containsMouse ? root.textPrimary : root.accent
            ...
            Row {
                ...
                Text {
                    text: "REBOOT"; font.family: Orbitron; font.pixelSize: 12 * s; font.letterSpacing: 2 * s; color: reboot2Ma.containsMouse ? root.textPrimary : root.textSecondary
                ...
                Text {
                    text: "SHUTDOWN"; font.family: Orbitron; font.pixelSize: 12 * s; font.letterSpacing: 2 * s; color: power2Ma.containsMouse ? "#ff6b6b" : root.textSecondary
            ...
            ListView {
                ...
                delegate: Item {
                    ...
                    Text {
                        ...
                        font.family: Orbitron; font.pixelSize: 13 * s; font.letterSpacing: 2 * s
