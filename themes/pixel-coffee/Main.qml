...
Rectangle {
    ...
    Column {
        ...
        Row {
            ...
            Text { text: Qt.formatDate(new Date(), "dddd, MMMM d").toUpperCase(); color: root.steel; font.family: "Pixelify Sans"; font.pixelSize: 12 * s; font.letterSpacing: 4 * s; anchors.verticalCenter: parent.verticalCenter; font.weight: Font.Bold }
        }
        Text {
            id: clockText
    ...
    Item {
        ...
        Column {
            ...
            Item {
                ...
                TextInput {
                    id: pwd; anchors.fill: parent; color: root.latte; font.family: "Pixelify Sans"; font.pixelSize: 18 * s; font.letterSpacing: 4 * s; font.weight: Font.Bold
            ...
            Item {
                ...
                Text {
                    ...
                    text: "LOGIN"
                    color: sbm.containsMouse ? "#000" : root.latte
                    font.family: "Pixelify Sans"
                    font.pixelSize: 12 * s
            ...
            Text { id: err; text: ""; color: "#ff4444"; anchors.horizontalCenter: parent.horizontalCenter; font.family: "Pixelify Sans"; font.pixelSize: 10 * s; font.weight: Font.Bold }
        }
    }
