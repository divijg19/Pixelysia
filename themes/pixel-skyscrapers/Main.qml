...
Rectangle {
    ...
    Column {
        ...
        Text {
            ...
            color: root.sunCream; font.family: "Pixelify Sans"; font.weight: Font.Bold; font.pixelSize: 84 * s; font.letterSpacing: -2 * s
        ...
        Text {
            ...
            color: root.roseUI; font.family: "Pixelify Sans"; font.weight: Font.Bold; font.pixelSize: 12 * s; font.letterSpacing: 4 * s
        }
    }
    ...
    Column {
        ...
        Item {
            ...
            Text {
                ...
                color: unm.containsMouse ? "white" : root.sunCream; font.family: "Pixelify Sans"; font.weight: Font.Bold; font.pixelSize: 22 * s; font.letterSpacing: 4 * s
        ...
        Item {
            ...
            TextInput {
                id: pwd; anchors.fill: parent; color: root.peachSky; font.family: "Pixelify Sans"; font.weight: Font.Bold; font.pixelSize: 18 * s; font.letterSpacing: 4 * s
            ...
            Text { anchors.centerIn: parent; text: "password..."; color: root.roseUI; opacity: 0.5; font.family: "Pixelify Sans"; font.weight: Font.Bold; font.pixelSize: 14 * s; font.letterSpacing: 4 * s; visible: !pwd.text && !pwd.activeFocus }
        }
        ...
        Item {
            ...
            Text { anchors.centerIn: parent; text: "LOG IN"; color: sbm.containsMouse ? "#000" : root.sunCream; font.family: "Pixelify Sans"; font.weight: Font.Bold; font.pixelSize: 12 * s; font.letterSpacing: 4 * s; Behavior on color { ColorAnimation { duration: 150 } } }
            MouseArea { id: sbm; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor; onClicked: doLogin() }
        }
        Text { id: err; text: ""; color: "#ff5555"; anchors.horizontalCenter: parent.horizontalCenter; font.family: "Pixelify Sans"; font.weight: Font.Bold; font.pixelSize: 12 * s }
    }
    ...
    Row {
        ...
        Repeater {
            model: [{l: "RESTART", a: 0}, {l: "POWER", a: 1}]
            delegate: Item {
                width: pmt.implicitWidth; height: 30 * s
                Text {
                    id: pmt; anchors.centerIn: parent; text: modelData.l
                    color: pm.containsMouse ? "white" : root.sunCream; font.family: "Pixelify Sans"; font.weight: Font.Bold; font.pixelSize: 11 * s; font.letterSpacing: 2 * s
                    layer.enabled: true; layer.effect: DropShadow { color: "#80000000"; radius: 4; samples: 8; horizontalOffset: 1; verticalOffset: 1 }
                    Behavior on color { ColorAnimation { duration: 150 } }
                }
                Rectangle {
