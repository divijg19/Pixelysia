    ...
    Column {
        ...
        Column {
            ...
            Text {
                ...
                color: "white"; font.family: "Pixelify Sans"; font.pixelSize: 84 * s; font.weight: Font.Bold
            ...
            Row {
                ...
                Text { text: Qt.formatDate(new Date(), "dddd, MMMM d").toUpperCase(); color: root.lamp; font.family: "Pixelify Sans"; font.pixelSize: 12 * s; font.letterSpacing: 3 * s; anchors.verticalCenter: parent.verticalCenter; font.weight: Font.Bold }
            }
        }
        ...
        Column {
            ...
            Text { text: (userModel.lastUser || "kamikuma").toUpperCase(); color: "white"; font.family: "Pixelify Sans"; font.pixelSize: 24 * s; font.letterSpacing: 4 * s; font.weight: Font.Bold
            ...
            Item {
                ...
                TextInput {
                    id: pwd; anchors.fill: parent; color: root.lamp; font.family: "Pixelify Sans"; font.pixelSize: 18 * s; font.letterSpacing: 4 * s; font.weight: Font.Bold
                ...
                Text { anchors.verticalCenter: parent.verticalCenter; text: "password..."; color: root.rainBlue; opacity: 0.4; font.family: "Pixelify Sans"; font.pixelSize: 14 * s; font.letterSpacing: 4 * s; visible: !pwd.text && !pwd.activeFocus; font.weight: Font.Bold }
            }
            ...
            Row {
                ...
                Item {
                    ...
                    Text {
                        ...
                        text: "LOG IN"
                        color: sbm.containsMouse ? "#000" : root.lamp
            ...
            Text { id: err; text: ""; color: "#ff4444"; font.family: "Pixelify Sans"; font.pixelSize: 12 * s; font.weight: Font.Bold }
        }
    }
    ...
    Row {
        ...
        Repeater {
            ...
            delegate: Item {
                ...
                Text { id: pmt; anchors.centerIn: parent; text: modelData.l; color: "white"; font.family: "Pixelify Sans"; font.pixelSize: 10 * s; font.letterSpacing: 2 * s; font.weight: Font.Bold }
