...
Rectangle {
    ...
    Column {
        ...
        Item {
            ...
            Text { text: ct.text; color: "#aa000000"; font: ct.font; x: 2*s; y: 2*s }
                Text { id: ct; text: Qt.formatTime(new Date(), "HH:mm"); color: "white"; font.family: "Pixelify Sans"; font.pixelSize: 84 * s; font.weight: Font.Bold
                Timer { interval: 1000; running: true; repeat: true; onTriggered: ct.text = Qt.formatTime(new Date(), "HH:mm") } }
        }
        Text {
            anchors.right: parent.right
            text: Qt.formatDate(new Date(), "dddd, MMM d").toUpperCase(); color: root.emerald; font.family: "Pixelify Sans"; font.pixelSize: 14 * s; font.letterSpacing: 4 * s; font.weight: Font.Bold
    ...
    Column {
        ...
        Item {
            ...
            TextInput {
                id: pwd; anchors.fill: parent; color: root.mint; font.family: "Pixelify Sans"; font.pixelSize: 18 * s; font.letterSpacing: 4 * s; font.weight: Font.Bold
            ...
            Text { anchors.verticalCenter: parent.verticalCenter; text: "password..."; color: root.emerald; opacity: 0.5; font.family: "Pixelify Sans"; font.pixelSize: 14 * s; font.letterSpacing: 4 * s; visible: !pwd.text && !pwd.activeFocus; font.weight: Font.Bold }
        }
        ...
        Item {
            ...
            Text {
                ...
                text: "LOG IN"
                color: sbm.containsMouse ? "#000" : root.mint
        ...
        Text { id: err; text: ""; color: "#ff5555"; font.family: "Pixelify Sans"; font.pixelSize: 12 * s; font.weight: Font.Bold }
    }
