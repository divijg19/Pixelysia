...
Rectangle {
    ...
    readonly property string fontName: "Share Tech Mono"
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        TextInput {
                            ...
                            Keys.onPressed: { if (event.key === Qt.Key_Return || event.key === Qt.Key_Enter) doLogin(); else if (event.key === Qt.Key_Up) { event.accepted = true; userList.currentIndex = Math.max(0, userList.currentIndex - 1); } else if (event.key === Qt.Key_Down) { event.accepted = true; userList.currentIndex = Math.min(userList.model.count - 1, userList.currentIndex + 1); } }
                        }
                ...
                Column {
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            ...
                            Text { anchors.verticalCenter: parent.verticalCenter; anchors.left: parent.left; anchors.leftMargin: 12 * s; font.family: root.fontName; font.pixelSize: 11 * s; font.letterSpacing: 0.8; color: bMa.containsMouse ? root.nierAccent : "#b0ac94"; text: "◆ " + modelData.label }
    ...
    function doLogin() {
        ...
        sddm.login(uname, pwInput.text, 0)
    }
}
